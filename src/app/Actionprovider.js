    ...
    constructor(
      ...
      callGenAI = async (prompt) => {
        const chatCompletion = await openai.chat.completions.create(
          ...
          model: 'gpt-3.5-turbo',
          messages: [
            { role: "system", content: "You are an agricultural advisor specializing in farming practices, crop care, market prices, and other agricultural queries for farmers in India." },
